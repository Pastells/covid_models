...
parser.add_argument(
    "--E0", type=int, default=0, help="Initial number of latent individuals"
)
parser.add_argument(
    "--I0", type=int, default=10, help="Initial number of infected individuals"
)
parser.add_argument(
    "--R0", type=int, default=0, help="Initial number of inmune individuals"
)
parser.add_argument(
    "--delta1", type=float, default=0, help="Ratio of recovery from latent fase (E->R)"
)
parser.add_argument(
    "--delta2",
    type=float,
...
S_day, E_day, I_day, R_day = (
    np.zeros([nseed, t_total]),
    np.zeros([nseed, t_total]),
    np.zeros([nseed, t_total]),
    np.zeros([nseed, t_total]),
)
